    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-zinc-950">
      ...
      <div className="absolute bottom-10 left-0 w-full overflow-hidden pointer-events-none opacity-5">
        <div className="whitespace-nowrap animate-marquee">
          <span className="text-[10rem] font-display font-bold text-white mx-8">DESIGN</span>
          <span className="text-[10rem] font-display font-bold text-white mx-8">DEVELOP</span>
          <span className="text-[10rem] font-display font-bold text-white mx-8">DEPLOY</span>
          <span className="text-[10rem] font-display font-bold text-white mx-8">SCALE</span>
        </div>
      </div>
    </section>
  );
