      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-end">
          ...
          <div className="lg:col-span-4 relative">
            ...
            <div className="absolute bottom-0 right-0 p-6 bg-slate-50 dark:bg-zinc-900 border border-slate-300 dark:border-zinc-800 max-w-[200px] transition-colors shadow-sm dark:shadow-none">
