...
export const AiConsultant: React.FC = () => {
  ...
  return (
    <section id="ai-consultant" className="py-24 bg-slate-50 dark:bg-zinc-950 border-b border-slate-200 dark:border-zinc-800 transition-colors duration-300">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-2/3">
            <div className="border border-amber-200 dark:border-zinc-800 bg-amber-50/30 dark:bg-zinc-900/20 min-h-[500px] flex flex-col transition-colors shadow-sm dark:shadow-none">
                  ...
                  >
                    ...
                    <div
                      className={`max-w-[90%] p-6 border transition-colors ${msg.role === 'user'
                        ...
                        : 'bg-slate-50 dark:bg-zinc-900/50 text-slate-700 dark:text-zinc-300 border-slate-200 dark:border-zinc-800'
                        }`}
                    >
                      {msg.text}
                    </div>
              ...
              {/* Input Line */}
              <form onSubmit={handleSend} className="border-t border-slate-200 dark:border-zinc-800 p-4 bg-slate-50 dark:bg-zinc-950 flex items-center gap-4 transition-colors">
