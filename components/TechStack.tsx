...
export const TechStack: React.FC = () => {
    ...
    return (
        <section className="py-24 bg-amber-200 dark:bg-zinc-950 border-t border-amber-300 dark:border-zinc-800 overflow-hidden transition-colors duration-300">
            <div className="container mx-auto px-6 lg:px-12 mb-16">
                <div className="text-center">
                    <p className="text-xs uppercase tracking-[0.3em] text-amber-600 dark:text-zinc-500 mb-4">Technologies We Master</p>
                    <h2 className="text-4xl md:text-5xl font-display font-bold transition-colors">
                        <span className="text-sky-600 dark:text-white">Our Tech</span> <span className="text-amber-500 dark:text-white">Stack</span>
                    </h2>
                </div>
            </div>
            ...
            <div className="relative mb-8">
                <div className="flex animate-scroll-left">
                    {duplicatedStack.map((tech, index) => (
                        ...
                        >
                            <div className="w-24 h-24 md:w-28 md:h-28 bg-sky-200 dark:bg-zinc-900 border border-sky-300 dark:border-zinc-800 rounded-xl flex flex-col items-center justify-center gap-2 transition-all duration-300 hover:border-amber-400 dark:hover:border-zinc-600 hover:scale-110 shadow-sm dark:shadow-none">
                                <img
                                    src={tech.icon}
                                    alt={tech.name}
