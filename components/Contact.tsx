...
export const Contact: React.FC = () => {
   return (
      <section id="contact" className="py-32 bg-cyan dark:bg-zinc-950 relative border-t border-azure dark:border-zinc-800 transition-colors duration-300">
         <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
            ...
            <form className="space-y-12">
               <div className="grid md:grid-cols-2 gap-12">
                  <div className="group">
                     <label className="block text-xs uppercase tracking-widest text-black/70 mb-2 group-focus-within:text-azure dark:group-focus-within:text-white transition-colors">Name</label>
                  ...
                  <div className="group">
                     <label className="block text-xs uppercase tracking-widest text-black/70 mb-2 group-focus-within:text-azure dark:group-focus-within:text-white transition-colors">Email</label>
                     <input type="email" className="w-full bg-transparent border-b border-black/30 dark:border-zinc-800 py-4 text-black dark:text-white text-lg focus:outline-none focus:border-azure dark:focus:border-white transition-colors placeholder-black/50 dark:placeholder-zinc-600 hover:border-black/50 dark:hover:border-zinc-600" placeholder="jane@company.com" />
                  </div>
               </div>

               <div className="group">
                  <label className="block text-xs uppercase tracking-widest text-black/70 mb-2 group-focus-within:text-azure dark:group-focus-within:text-white transition-colors">Project Details</label>
               ...
               <div className="flex justify-center pt-8">
                  <Button variant="primary" size="lg" className="min-w-[200px] bg-azure text-white hover:bg-aqua dark:bg-white dark:text-black dark:hover:bg-zinc-200">
                     Submit Inquiry
                  </Button>
               </div>
            </form>
            ...
            <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center border-t border-black/20 dark:border-zinc-900 pt-12 transition-colors">
               <div>
                  <p className="text-xs uppercase tracking-widest text-black/60 dark:text-zinc-600 mb-2">Email</p>
               ...
               <div>
                  <p className="text-xs uppercase tracking-widest text-black/60 dark:text-zinc-600 mb-2">Phone</p>
               ...
               <div>
                  <p className="text-xs uppercase tracking-widest text-black/60 dark:text-zinc-600 mb-2">Location</p>
